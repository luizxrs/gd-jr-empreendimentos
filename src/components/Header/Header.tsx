...
export default function Header() {
  ...
  return (
    <>
      <header className="p-6 h-[85px] w-screen fixed flex justify-between items-center text-white antialiased bg-slate-300">
        <nav className="w-screen p-4">
          <div className="flex items-center justify-between">
            <a href="/">
              <Image src={Logo} alt="Logo da GD & JR Empreendimentos"></Image>
            </a>
            <div>
              <ul className="flex justify-between items-center p-2 gap-12">
                <HeaderElements.NavBarLi>EMPREENDIMENTOS</HeaderElements.NavBarLi>
                <HeaderElements.NavBarLi>SOBRE NÓS</HeaderElements.NavBarLi>
                <HeaderElements.NavBarLi>OPORTUNIDADES</HeaderElements.NavBarLi>
                <HeaderElements.NavBarLi>NOTÍCIAS</HeaderElements.NavBarLi>
                <HeaderElements.NavBarLi>FALE CONOSCO</HeaderElements.NavBarLi>
              </ul>
            </div>
            <div>
              <div className="flex items-center justify-between gap-4">
                <a
                  ...
                  className="SocialMediaUrlComponent__StyledLink-sc-b95cdaee-0 klYoYj"
                ...
                <a
                  ...
                  className="SocialMediaUrlComponent__StyledLink-sc-b95cdaee-0 klYoYj"
                  href="https://centralcorretor.com.br/perfil/GDJR"
                >
                  <svg
                    fill="currentColor"
                    className="h-8 w-8 "
