        ...
        <div className="flex flex-col justify-center items-center w-screen bg-backgroundColor-100">
          ...
          <section className="w-screen mb-24">
            <div className=" max-w-screen-2xl  mx-auto">
              ...
              <div className="h-[1100px] md:h-[900px] left-1/2 -translate-x-1/2 pt-48 px-4 md:px-12 relative">
            ...
            <div className=" w-full">
              <div className="w-full overflow-hidden">
                <div className="flex flex-col gap-2 my-12 justify-center items-center h-full">
                  ...
                  <AnimatedText text="CONSTRUINDO UM FUTURO MELHOR COM INOVAÇÃO, QUALIDADE E COM NOSSOS CLIENTES E O MEIO AMBIENTE." />
                </div>
